...
This repository is a Claude Skill covering the HTML headless component library for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-html-headless-skill.git
```
